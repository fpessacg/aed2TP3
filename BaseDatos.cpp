...
template <class T>
void BaseDatos<T>::AgregarTabla(Tabla& t){
...
template <class T>
void BaseDatos<T>::InsertarEntrada(const Registro& r, String& t){
...
template <class T>
void BaseDatos<T>::Borrar(const Registro& r, String& t){

}

// Devuelvo un iterador a los nombres de las tablas de la BD
template <class T>
aed2::Lista<NombreTabla>::Iterador BaseDatos<T>::Tablas() const{
...
template <class T>
Tabla& BaseDatos<T>::DameTabla(const NombreTabla& t) const{
...
template <class T>
NombreTabla& BaseDatos<T>::TablaMaxima() const{
	return this->nombreAccesoMax;
}

// Devuelve el campo para los cuales dos tablas estan vinculadas
template <class T>
NombreCampo& BaseDatos<T>::CampoJoin(const NombreTabla& t1, const NombreTabla& t2) const{
...
template <class T>
bool BaseDatos<T>::HayJoin(const NombreTabla& t1, const NombreTabla& t2) const{
	InfoTabla t1Info = this->tablasBD.Significado(t1);
...
template <class T>
void BaseDatos<T>::BorrarJoin(const NombreTabla& t1, const NombreTabla& t2) const{
	InfoTabla t1Info = this->tablasBD.Significado(t1);
...
template <class T> 
void BaseDatos<T>::GenerarVistaJoin(const NombreTabla& t1, const NombreTabla& t2, const NombreCampo& ca) const{
}

// Visualiza el Join entre dos tablas
template <class T> 
aed2::Conj<Registro> BaseDatos<T>::VistaJoin(const NombreTabla& t1, const NombreTabla& t2){
	InfoTabla t1Info = this->tablasBD.Significado(t1);
...
template <class T>
aed2::Conj<Registro> BaseDatos<T>::Buscar(const Registro& r, const NombreTabla& t) const{
	InfoTabla t1Info = this->tablasBD.Significado(t1);
...
template <class T>
NombreTabla BaseDatos<T>::EncontrarMaximo(const NombreTabla& t, const aed2::Conj<NombreTabla>&  conjTab) const{
	InfoTabla t1Info = this->tablasBD.Significado(t1);
...
template <class T>
aed2::Nat BaseDatos<T>::CantidadDeAccesos(const NombreTabla& t) const{
	InfoTabla t1Info = this->tablasBD.Significado(t1);
...
template <class T>
aed2::Conj<Registro>::Iterador BaseDatos<T>::Registros(const NombreTabla& t){
	InfoTabla t1Info = this->tablaBD.Significado(t);
